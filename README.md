...
Границы районов реальные, показатели районов синтетические (из датасета задачи). Полигон Есиля в OSM включает выделенный из него район Нура, поэтому Нура вычтена из Есиля.
